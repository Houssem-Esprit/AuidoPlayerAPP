                              ...
                              children: [
                                BlocBuilder<MusicBloc,MusicState>(
                                  builder: (context, musicState){
                                    return musicState is OpenAndPlayAudioPlayer?
                                    Row(
                                      children: [
                                        Text("${index}.",
                                          style: TextStyle(
                                        ...
                                        GestureDetector(
                                          onTap: (){
                                            this.index=index;
                                            context.read<MusicBloc>().add(TrackTaped(url:"http:localhost:3000/public/audios/"+state.tracks[index].audio,index: index));
                                ...
                                BlocBuilder<MusicBloc,MusicState>(
                                  builder: (context, musicState){
                                    return musicState is TrackPositionState?
                                    Row(
                                      children: [
                                        musicState.assetsAudioPlayer.builderCurrentPosition(
                                            builder:(context, duration){
                                              int currentIndex = musicBloc.currentIndex;
                                              return  Text(currentIndex==index? durationToString(duration):"01:15",
                                                style: TextStyle(
                                                  fontFamily: "SFProDisplay/FontsFree-Net-SFProDisplay-Light.ttf",
                                                  fontSize: 12.0,
                                                  color: Colors.white,
